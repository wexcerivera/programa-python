...
menu = [
    ...
    ["Chorizo Artesanal", "Carnes", 7000],
    ["Parrillada Mixta", "Parrilladas", 45000],
    ["Papas a la Francesa", "Acompanamientos", 2000],
...
# Mostrar informe
print("INFORME DE PRECIOS - RESTAURANTE LAS DELICIAS")
print("=" * 50)
print("Producto          | Categoria       | Precio Base | Precio Final | Descuento")
print("-" * 50)
